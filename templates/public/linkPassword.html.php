...
?>
<body>
    <form action="<?= $router->generatePath('public-confirmLinkPassword')?>" method="get">
        <div class="container">
            ...
            <input type="hidden" name="action" id="action" value="public-confirmLinkPassword">
            <button class="button btn-primary" type="submit" name="submit">Sprawdź hasło</button>
        </div>
    </form>
</body>
